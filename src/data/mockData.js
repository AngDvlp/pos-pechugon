...
export const initialProducts = [
  ...
  { sku: 'B-003', name: 'ORDEN DE 8 TACOS', category: 'basicos', cost: 35.00, price: 74.00, stock: 0, minStock: 5, color: '#f97316', baseProductSku: 'B-001', baseEquivalence: 1.0 },
  { sku: 'B-004', name: '1/2 PECHUGÓN', category: 'basicos', cost: 60.00, price: 114.00, stock: 0, minStock: 3, color: '#f97316', baseProductSku: 'B-001', baseEquivalence: 0.5 },
  { sku: 'B-005', name: '1/4 PECHUGÓN', category: 'basicos', cost: 35.00, price: 70.00, stock: 0, minStock: 3, color: '#f97316', baseProductSku: 'B-001', baseEquivalence: 0.25 },
  { sku: 'B-006', name: 'TACO', category: 'basicos', cost: 5.00, price: 11.00, stock: 0, minStock: 15, color: '#f97316', baseProductSku: 'B-001', baseEquivalence: 0.125 },
  { sku: 'B-007', name: 'ORDEN DE 5 TACOS', category: 'basicos', cost: 22.00, price: 49.00, stock: 0, minStock: 5, color: '#f97316', baseProductSku: 'B-001', baseEquivalence: 0.625 },
  { sku: 'B-008', name: 'ORDEN DE PAPAS', category: 'basicos', cost: 15.00, price: 35.00, stock: 0, minStock: 8, color: '#eab308' },
  { sku: 'B-009', name: '1/2 ORDEN DE PAPAS', category: 'basicos', cost: 8.00, price: 19.00, stock: 0, minStock: 8, color: '#eab308', baseProductSku: 'B-008', baseEquivalence: 0.5 },
  { sku: 'B-010', name: '5 TACOS JUEVES', category: 'basicos', cost: 20.00, price: 45.00, stock: 0, minStock: 5, color: '#f97316', baseProductSku: 'B-001', baseEquivalence: 0.625 },
  { sku: 'B-011', name: 'TACOS 10 X', category: 'basicos', cost: 30.00, price: 69.00, stock: 0, minStock: 5, color: '#f97316', baseProductSku: 'B-001', baseEquivalence: 1.25 },
  { sku: 'B-012', name: '1/2 ORDEN COSTILLAS', category: 'basicos', cost: 28.00, price: 59.00, stock: 0, minStock: 3, color: '#f97316', baseProductSku: 'B-014', baseEquivalence: 0.5 },
  { sku: 'B-013', name: '1 COSTILLA', category: 'basicos', cost: 7.00, price: 15.00, stock: 0, minStock: 5, color: '#f97316', baseProductSku: 'B-014', baseEquivalence: 0.125 },
  ...
  { sku: 'B-016', name: '4 CHILES RELLENOS', category: 'basicos', cost: 22.00, price: 49.00, stock: 0, minStock: 3, color: '#f97316', baseProductSku: 'B-015', baseEquivalence: 4.0 },
  { sku: 'B-017', name: '2 CHILES RELLENOS', category: 'basicos', cost: 14.00, price: 30.00, stock: 0, minStock: 3, color: '#f97316', baseProductSku: 'B-015', baseEquivalence: 2.0 },
  { sku: 'B-018', name: '20 PEZCUESOS X 39', category: 'basicos', cost: 18.00, price: 39.00, stock: 0, minStock: 5, color: '#f97316', baseProductSku: 'B-002', baseEquivalence: 20.0 },
  ...
  { sku: 'C-009', name: 'SALSA GRANDE', category: 'complementos', cost: 12.00, price: 30.00, stock: 0, minStock: 5, color: '#3b82f6', baseProductSku: 'C-008', baseEquivalence: 2.0 },
  ...
  { sku: 'V-005', name: 'ALITAS 5 PIEZAS', category: 'varios', cost: 22.00, price: 49.00, stock: 0, minStock: 5, color: '#10b981', baseProductSku: 'V-004', baseEquivalence: 0.5 },
